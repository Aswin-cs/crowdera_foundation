...
const ShapeGrid = ({
  ...
  useEffect(() => {
    ...
    const drawGrid = () => {
      ...
      // I am commenting this out because a hardcoded radial gradient to black 
      // is not ideal for the theme. The site's background is mostly light blue (#E3F2FD).
      // We will handle background styles in the layout.
      /*
