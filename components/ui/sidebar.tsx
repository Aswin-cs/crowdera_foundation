...
export const DesktopSidebar = ({
  ...
  return (
    <>
      <motion.div
        className={cn(
          "h-full py-4 hidden md:flex md:flex-col bg-white w-[300px] shrink-0 border-r border-neutral-200",
          className
        )}
        animate={{
        ...
        transition={{
          duration: 0.4,
          ease: [0.4, 0, 0.2, 1], // Custom cubic-beizer for premium feel
        }}
...
export const SidebarLink = ({
  ...
  return (
    <a
      href={link.href}
      className={cn(
        "flex items-center gap-2 group group/sidebar py-2 px-2 rounded-md transition-all relative z-10",
        open ? "justify-start" : "justify-center",
        !active && "hover:bg-neutral-200",
        className
      )}
      {...props}
    >
      ...
      <motion.span
        ...
        className={cn(
          ...
          active ? "text-primary font-bold" : "text-neutral-700"
        )}
      >
        {link.label}
      </motion.span>
